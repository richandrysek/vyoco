...
build {
  ...
  provisioner "shell" {
    ...
    inline   = [
      ...
      "echo \"git clone -b ${lookup(var.yocto_poky_rev, var.yocto_identifier, var.yocto_identifier)} --single-branch git://git.yoctoproject.org/poky.git\" > ${var.yocto_workspace_dir}/source/clone_poky.sh",
    ]
  }
